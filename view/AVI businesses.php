...
========
            ...
            <a href="../TAC.php" class="links">
                <li class="link">
                    <img class="nav-logo" src="./../../assets/tac-icon.svg" alt="Teaching Across Curriculum Icon">
>>>>>>>> a0ab27656da31ead928913ebe1eb320439586709:view/AVI/AVI businesses.php
                    ...
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3">
<<<<<<<< HEAD:view/AVI businesses.php
                                    <img src="" alt="Hybrid businesses image">
========
                    ...
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3">
<<<<<<<< HEAD:view/AVI businesses.php
                                    <img src="" alt="For profit businesses image">
========
