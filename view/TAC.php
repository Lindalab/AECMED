                    ...
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <img src="" alt="Student businesses image">
                                </div>
                            </div>
                        </div> 
                    </li>
                </a>
                <a href="TAC grants.php">
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-9">
                                ...
                                <div class="col-3">
                                    <img src="" alt="Student grants image">
                                </div>
                            </div>
                        </div> 
                    </li>
                </a>
                <a href="TAC clubs.php">
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-9">
                                ...
                                <div class="col-3">
                                    <img src="" alt="Campus clubs image">
                                </div>
                            </div>
                        </div> 
                    </li>
                </a>
                <a href="TAC events.php">
                    <li class="card" style="width: 22rem;">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-9">
