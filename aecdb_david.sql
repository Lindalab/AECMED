...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 16, 2023 at 10:54 AM
...
(1, 2022, 'Fruit On Wheels ', '../images/business_logos/fruit_on_wheels.png', 'Ashesi Accra Ghana', '0242430210', 'fruitonwheel@gmail.com', 1, 1, 'Agric', 'Making a change where it is needed'),
(2, 2021, 'Torri Cosmetics', '../images/business_logos/torri.png', 'Accra, Ghana', '0243820331', 'torri@gmail.com', 3, 1, 'Cosmetics', 'Experience luxury with Torri cosmetics! Our line of high-quality makeup and skincare products are designed to enhance your natural beauty and leave you feeling confident and radiant. From nourishing serums to long-lasting lipsticks, we have something for every occasion. All of our products are cruel'),
(3, 2020, 'The Traveling Trunk', '../images/business_logos/traveling_trunk.jpg', 'Tarkoradi', '02438212321', 'travellingtrunk@gmail.com', 3, 3, 'Travelling', 'Step into the past with The Traveling Trunk, your go-to destination for unique and one-of-a-kind vintage and antique finds. Our shop is filled with treasures from around the world, ranging from antique furniture and home decor to vintage clothing and accessories. Each piece is hand-selected for its '),
(25, 2022, 'The Camp Fires THREE', '../images/business/eric.JPG', 'Accra', '0245332548', 'arthurlinda968@gmail.com', 1, 0, 'agriculture', 'Amazng'),
(26, 2012, 'Ashaiman', '../images/business/courtyard.jfif', 'Accra', ' 0238270332', 'eric.gadzi@ashesi.edu.gh', 3, 0, 'trial', 'Amazing');
...
INSERT INTO `business_details` (`business_id`, `number_of_employees`, `formalised_structure`, `sdg_alignment`) VALUES
(1, 10, '', '3,7,11,12,'),
(2, 20, '', '4'),
(3, 10, 'gra', '1,5,8'),
(25, 2, 'GRA, FDA', '4,7,9,12,'),
(26, 19, 'GRA, FDA', '4,7,11,');

-- --------------------------------------------------------

--
-- Table structure for table `business_employment`
--

CREATE TABLE `business_employment` (
  `business_id` int(11) NOT NULL,
  `employment_created` int(11) NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `business_grants` (`grant_id`, `business_id`, `amount`, `date`) VALUES
(1, 1, 12345, '2023-01-23'),
(2, 2, 3000, '2023-01-08'),
(2, 3, 700, '2023-01-08'),
(4, 2, 5000, '2023-01-08'),
(3, 2, 100, '2023-01-08'),
...
(4, 3, 300, '2023-01-08'),
(6, 3, 100, '2023-01-08'),
(17, 2, 1000, '2023-01-26'),
(17, 26, 10000, '2023-01-04'),
(2, 1, 20000, '2023-01-05'),
(16, 1, 1000, '2023-01-20'),
(17, 26, 12345, '2023-01-19'),
(6, 26, 200, '2023-01-21'),
(15, 26, 30, '2023-01-21'),
(2, 25, 30, '2023-01-25'),
(16, 25, 1000, '2023-01-26');
...
CREATE TABLE `clubs` (
  ...
  `number_of_excutives` int(5) NOT NULL,
  `number_of_members` int(5) NOT NULL,
  `number_of_females` int(5) NOT NULL,
  `number_of_males` int(5) NOT NULL,
...
INSERT INTO `clubs` (`club_id`, `name`, `description`, `number_of_excutives`, `number_of_members`, `number_of_females`, `number_of_males`, `date_registered`, `department`, `lead_name`) VALUES
(1, 'Cell Not Hell', 'Everybody deserves better', 2, 20, 10, 10, '2020-09-11', 3, 'David'),
(2, 'BioTechniques', 'Science made simpler and convenient', 3, 23, 10, 10, '2022-12-07', 3, 'Eric');
...
INSERT INTO `cohort` (`cohort_id`, `cohort_name`, `cohort_year`) VALUES
(1, 'Cohort 1', 2019),
(2, 'Cohort 2', 2022);
...
--
-- Table structure for table `cohort_business`
--
...
--
-- Dumping data for table `cohort_business`
--

INSERT INTO `cohort_business` (`business_id`, `cohort_id`) VALUES
(1, 1),
(1, 2);
...
(7, 'Community Entrepreneurship', '2023-01-01', 'Lorem', 0, 3);

-- --------------------------------------------------------

--
-- Table structure for table `course_grant`
--
...
--
-- Dumping data for table `course_grant`
--

INSERT INTO `course_grant` (`course_id`, `grant_id`, `amount_given`, `date`) VALUES
(1, 6, 1000, '2022-12-08'),
(2, 2, 300, '2021-12-01'),
(3, 1, 200, '2022-10-21'),
(4, 4, 5000, '2022-12-15'),
...
(1, 'The Education Summit', '2022-01-20', 'seniors', 'A conference that brings together educators, administrators, and policymakers to discuss the latest developments in education', 100, 150, 'summit', 1),
(2, ' The Science Fair', '2023-10-30', '', 'An event that showcases the scientific projects and research of students from all grade levels.', 159, 141, 'exhibition', 1),
...
(5, 'The Reading Festival', '2023-01-11', 'alumni', 'lorem', 120, 80, 'hackathon', 1),
...
(21, 'FARMERS DAY', '2023-01-20', 'Seniors', 'This is amaxing                                                                                                                                    ', 300, 10, 'Info-session', 3),
(22, 'Shatta Wale Concert', '2023-01-11', 'Seniors', 'This is great', 25, 30, 'Info-session', 3);
...
(1, 'Small Business Innovation Research Grant', 1, '2022-12-01', 'A grant program that provides funding to small businesses to conduct research and development (R&D) projects with the potential for commercialization.', '../grants/image1.jpg', 1, 2000),
(2, ' Small Business Technology Transfer (STTR)', 1, '2022-12-07', 'A grant program that provides funding to small businesses to collaborate with research institutions on R&D projects with the potential for commercialization', '../grants/image1.jpg', 1, 3000),
(3, ' Rural Business Development Grants (RBDG)', 1, '2022-12-01', ' A grant program that provides funding to support economic development projects in rural areas, including business development, entrepreneurship, and job creation', '../images/image2.jpg', 2, 4000),
...
(11, 'Aseda', 2, '2023-01-11', 'amzing', '../images/grants/Chart.jpeg', 1, 8000),
(15, 'Something for the boys', 2, '2025-01-25', 'Amazing', '../images/grants/PWAs4.jpg', 3, 100),
(16, 'Amazing', 1, '2023-01-27', 'This is great', '../images/grants/Ashesi_Campus_16-min.jpg', 1, 1000),
(17, 'Aseda', 1, '2023-01-13', 'Amazing', '../images/grants/Ashesi_Campus_16-min.jpg', 3, 1000),
(18, 'Women Business Ownership Assistance (WBOA)', 1, '2023-01-22', 'greatness', '../images/grants/Ashesi_Campus_16-min.jpg', 1, 1000);
...
(32, 'The Business Plan Blueprint', 'Create a solid foundation for your business with our course on developing a business plan', 1);
...
(2, 'The Student Mentorship Program', 'A program that pairs high school students with mentors from local businesses, providing them with hands-on experience and guidance as they explore career paths', 2, '2021-08-02', '5', 1, 'Education', '../images/project/image2.jpg'),
...
(8, 'The Student-Led Conference', 'A project that engages students in community service and volunteering efforts, with the goal of making a positive impact in the local community.', 2, '2021-12-16', '1, 2,3', 3, 'Community Development', '../images/project/image9.jpg'),
...
(14, 'Cell Not Hell PHSAE II', 'Amazing', 1, '2023-01-06', '10', 1, 'Travelling', '../images/projects/download.png'),
(16, 'Cell Not Hell', 'Amazing', 1, '2023-01-19', '', 3, 'Travelling', '../images/projects/Chart.png');
...
(21, 'Rachel II', 'Michael', 1, 1, 'abc1@gmail.com', '0596547234', ''),
(22, 'Jessica 2', 'David', 1, 1, 'abcd00@gmail.com', '0245874311', ''),
...
(41, 'Eric', 'Eric', 1, 0, 'eric.gadzi@ashesi.edu.gh', '0558270332', '../images/stakeholders/liquid_soap.jpg');
...
--
-- Indexes for table `business_employment`
--
ALTER TABLE `business_employment`
  ADD KEY `business_id` (`business_id`);
...
--
-- Indexes for table `cohort_business`
--
ALTER TABLE `cohort_business`
  ADD KEY `cohort_business_ibfk_1` (`business_id`),
  ADD KEY `cohort_business_ibfk_2` (`cohort_id`);
...
--
-- Indexes for table `course_grant`
--
ALTER TABLE `course_grant`
...
--
ALTER TABLE `business`
  MODIFY `business_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT for table `clubs`
--
ALTER TABLE `clubs`
  MODIFY `club_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `cohort`
--
ALTER TABLE `cohort`
  MODIFY `cohort_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `grants`
  MODIFY `grant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `stakeholder`
  MODIFY `stakeholder_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
-- Constraints for table `business_employment`
--
ALTER TABLE `business_employment`
  ADD CONSTRAINT `business_employment_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `business` (`business_id`);
...
--
-- Constraints for table `cohort_business`
--
ALTER TABLE `cohort_business`
  ADD CONSTRAINT `cohort_business_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `business` (`business_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `cohort_business_ibfk_2` FOREIGN KEY (`cohort_id`) REFERENCES `cohort` (`cohort_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `course_grant`
--
ALTER TABLE `course_grant`
  ADD CONSTRAINT `course_grant_ibfk_1` FOREIGN KEY (`course_id`) REFERENCES `course` (`course_id`),
  ADD CONSTRAINT `course_grant_ibfk_2` FOREIGN KEY (`grant_id`) REFERENCES `grants` (`grant_id`);
