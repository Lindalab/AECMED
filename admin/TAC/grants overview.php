...
<head>
    ...
    <title>AEC - TAC Grants Overview</title>
</head>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="../D-Lab/internal.php">Internal grants</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="../D-Lab/external.php">External grants</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
