...
<head>
    ...
    <title>AEC - Undergraduate Programs Community Entrepreneurship</title>
</head>
        ...
        <div class="nav-left-sidebar sidebar-dark">
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link active" href="community entrepreneurship.php"><i
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="community entrpreneurship.php"
                                                class="breadcrumb-link">Community Entrepreneurship</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Community Entrepreneurship (View)</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
