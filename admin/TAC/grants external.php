...
<head>
    ...
    <title>AEC - Undergraduate Programs External Grants</title>
</head>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo count_grant_type_and_department_ctr(TAC, EXTERNAL)?></h1>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                <?php displa_all_grant_types(TAC, EXTERNAL) ?>
