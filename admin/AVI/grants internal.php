                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-4" class="collapse submenu-danger">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="grants internal.php active">Internal grants</a>
                                        </li>
                                        <li class="nav-item">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="../../forms/add/add-grant.php?department=<?php echo AVI ?>&type=<?php echo INTERNAL ?>" class="btn btn-primary">Add grant +</a>
                                </div>
