<?php 
    ...
    class Business extends db_connection{
        ...
        function select_one_business($business_id){
            $sql = "SELECT  business.*, business_details.formalised_structure as formalised_structure, number_of_employees, business_details.sdg_alignment as sdg_alignment FROM business,business_details where  business.business_id=business_details.business_id and business.business_id = $business_id";
